                            ...
                            <table>
                                ...
                                <tbody>
                                    <c:if test="${user != null}"> <!-- Check if user is logged in -->
                                        <c:forEach var="var" items="${order.orderDetails}">
                                            <tr>
                                                ...
                                                <td class="product__cart__item">
                                                    <div class="product__cart__item__text">
                                                        <h6>${var.orderDetailID}</h6>
                                                    </div>
                                                </td>
												<td class="product__cart__item d-flex">
													<div class="border mr-2">
														<img src="${var.product.imageURL}" width="100px"/>
													</div>
                                                    <div class="quantity my-auto">
														<p class="p-0"><b>Name: </b>${var.product.productName}</p>
														<p class="p-0"><b>Price: </b>${var.product.price}</p>
                                                    </div>
                                                </td>
